// DebtFree service worker (PWA offline-first). Serves the built Vite bundle.
// CACHE_VERSION is rewritten by CI to the git short SHA on every deploy,
// so clients pick up new bundles immediately.
const CACHE = 'debtfree-v2-' + self.__DEBTFREE_CACHE_VERSION__;
...
// Offline-first: serve cached, refresh in the background when online.
