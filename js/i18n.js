// DebtFree — i18n (EN / PT-BR). Canonical source: /locales/*.json.
...
(function () {
  ...
  function setLang(lang) {
    ...
    current = lang;
    try { localStorage.setItem('df_lang', lang); } catch { /* ignore */ }
    applyStatic();
    document.dispatchEvent(new CustomEvent('debtfree:langchange'));
  }
